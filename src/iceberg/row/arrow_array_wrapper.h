...
class ICEBERG_EXPORT ArrowArrayStructLike : public StructLike {
 public:
  ...
  Result<ViewValue> GetField(size_t pos) const override;
...
class ICEBERG_EXPORT ArrowArrayArrayLike : public ArrayLike {
 public:
  ...
  Result<ViewValue> GetElement(size_t pos) const override;
...
class ICEBERG_EXPORT ArrowArrayMapLike : public MapLike {
 public:
  ...
  Result<ViewValue> GetKey(size_t pos) const override;

  Result<ViewValue> GetValue(size_t pos) const override;
