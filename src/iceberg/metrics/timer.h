...
///
/// Mirrors org.apache.iceberg.metrics.Timer. Use Start() to obtain a Timed RAII
...
class ICEBERG_EXPORT Timer {
 public:
  ...
  ///
  /// Mirrors org.apache.iceberg.metrics.Timer.Timed (AutoCloseable in Java).
  ...
  /// \brief Record a duration directly.
...
///
/// Mirrors org.apache.iceberg.metrics.DefaultTimer.
