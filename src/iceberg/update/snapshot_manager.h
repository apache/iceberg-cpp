...
class ICEBERG_EXPORT SnapshotManager : public PendingUpdate {
 public:
  ...
  Kind kind() const final {
    // SnapshotManager doesn't map to a specific PendingUpdate::Kind
    // It manages multiple types of operations
  ...
  /// \throws IllegalArgumentException If the table has no snapshot with the given id
  ...
  /// \return Reference to this for method chaining
  /// \throws IllegalArgumentException If the table has no old snapshot before the given
  /// timestamp
  ...
  /// \return Reference to this for method chaining
  /// \throws IllegalArgumentException If the table has no snapshot with the given id
  /// \throws ValidationException If given snapshot id is not an ancestor of the current
  /// state
  ...
  /// \return Reference to this for method chaining
  /// \throws IllegalArgumentException if a branch with the given name already exists
  ...
  /// \return Reference to this for method chaining
  /// \throws IllegalArgumentException if a tag with the given name already exists
  ...
  /// \param name Branch name
  /// \return Reference to this for method chaining
  /// \throws IllegalArgumentException if the branch does not exist
  ...
  /// \param name Tag name
  /// \return Reference to this for method chaining
  /// \throws IllegalArgumentException if the tag does not exist
  ...
  /// \return Reference to this for method chaining
  /// \throws IllegalArgumentException if from is not an ancestor of to
  ...
  /// \return Reference to this for method chaining
  /// \throws IllegalArgumentException if the branch to rename does not exist or if there
  /// is already a branch with the same name as the desired new name
  ...
  /// \return Reference to this for method chaining
  /// \throws IllegalArgumentException if the reference does not exist
